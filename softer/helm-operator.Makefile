...
# laidback.github.io/softer-bundle:$VERSION and laidback.github.io/softer-catalog:$VERSION.
IMAGE_TAG_BASE ?= laidback.github.io/softer
...
IMG ?= ghcr.io/laidback/softer:0.0.1
...
.PHONY: run-kube
run-kube: helm-operator ## Run against the configured Kubernetes cluster in ~/.kube/config
	$(HELM_OPERATOR) run

.PHONY: docker-build
docker-build: ## Build docker image with the manager.
	docker build -t ${IMG} -f helm-operator.Dockerfile .
